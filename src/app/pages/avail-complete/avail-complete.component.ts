...
@Component({
  selector: 'app-avail-complete',
  templateUrl: './avail-complete.component.html',
  styleUrls: ['./avail-complete.component.scss']
})
export class AvailCompleteComponent implements OnInit {
  showDetails: any;
  showStatus: any;
  width: any;
  posts: any;
