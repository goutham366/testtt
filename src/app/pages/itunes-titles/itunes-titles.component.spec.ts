...
describe('ItunesTitlesComponent', () => {
    ...
    "resultData": [
      {
        ...
        "AvailName": "IN JUL092019",
        "AnnouncementDate": "09/24/2019",
        "GlobalTitle": "Lost in a Harem",
        "ImageURL": "",
        "TitleStatus": [
          {
  ...
  beforeEach(() => {
    ...
    component.accounttitlesresp = itunesdata;
  ...
  it('should able to click the accounts', () => {
    let GlobalTitle = 'Lost in a Harem', tab = 'titles';
  ...
  it('should able to select countries', () => {
    let GlobalTitle = 'Lost in a Harem', tab = 'countries';
    component.selectTab(GlobalTitle, tab);
  })
  it('should able to select languages', () => {
    let GlobalTitle = 'Lost in a Harem', tab = 'languages';
    component.selectTab(GlobalTitle, tab);
  })
  ...
  it('should able to get itunes details', () => {
    service.getAccountTittlesData('IN JUL092019');
    ...
    service.getAccountTittlesData('IN JUL092019');
    let url = "https://jcm3vwswzd.execute-api.us-west-2.amazonaws.com/Stage//avails/ITUNES/IN%20JUL092019";
    ...
    let GlobalTitle = 'Lost in a Harem'
