(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser'), require('rxjs/BehaviorSubject'), require('rxjs/observable/timer'), require('rxjs/Subject'), require('rxjs/observable/of'), require('rxjs/operators'), require('rxjs/observable/empty'), require('rxjs/operators/map')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/platform-browser', 'rxjs/BehaviorSubject', 'rxjs/observable/timer', 'rxjs/Subject', 'rxjs/observable/of', 'rxjs/operators', 'rxjs/observable/empty', 'rxjs/operators/map'], factory) :
	(factory((global['ngx-progressbar'] = global['ngx-progressbar'] || {}, global['ngx-progressbar'].core = {}),global.ng.core,global.ng.common,global.ng.platformBrowser,global.Rx,global.Rx.Observable,global.Rx,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable,global.Rx.Observable.prototype));
}(this, (function (exports,core,common,platformBrowser,BehaviorSubject,timer,Subject,of,operators,empty,map$1) { 'use strict';
...
var NgProgressRef = (function () {
    ...
    function NgProgressRef(config) {
        ...
        /**
             ...
             */
        this._workerSub$ = this._trickling$.pipe(operators.combineLatest(this.config$), operators.switchMap(function (_a) {
    ...
    NgProgressRef.prototype._trickling = function (config) {
        var _this = this;
        return timer.timer(0, config.trickleSpeed).pipe(operators.tap(function () { return _this.inc(); }));
    };
    /**
...
var NgProgressComponent = (function () {
    ...
    NgProgressComponent.prototype.ngOnChanges = function () {
        if (this.progressRef instanceof NgProgressRef) {
            ...
            this.state$ = this.progressRef.state$.pipe(map$1.map(function (state) { return ({
                active: state.active,
